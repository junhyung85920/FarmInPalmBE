...
INSERT INTO stock (stock_id, stock_name, stock_quantity, stock_unit)
VALUES
    (1, 'Fertilizer', 100.1, 'kg'),
    (2, 'Pesticide', 50.4, 'L'),
    (3, 'Seeds', 200.0, 'kg'),
    (4, 'Irrigation System', 10.0, 'unit'),
    (5, 'Greenhouse', 5.0, 'unit');

INSERT INTO monitor (monitor_id, monitor_name, temperature, humidity, ground_temperature, ground_humidity, co2concentration, date)
VALUES
...
INSERT INTO event (event_id, event_title, event_start_date, event_start_day, event_end_date, event_end_day)
VALUES
